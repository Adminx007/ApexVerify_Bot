...
BOT_TOKEN = "8873118288:AAE-tRbAfzVgXDCgbrd9_CwGTXaMaG_lTsc"
...
# অত্যন্ত দ্রুত এপিআই রিকোয়েস্ট নিশ্চিত করতে অপ্টিমাইজড ক্লায়েন্ট সেটিংস
                ...
                for otp in otps:
                    ...
                    if (matched_key is not None and
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ PANEL", url="https://t.me/apexverifygroup", style="primary"),
                                InlineKeyboardButton("📢 CHANNEL", url="https://t.me/ApexVerifyBotOfficial", style="primary")
                            ]
                        ])
...
async def fetch_number_async(range_str):
    ...
    try:
        ...
        for part in reversed(parts):
            ...
            if len(clean_part) >= 7 and clean_part.isdigit():
        ...
        if len(clean_all) >= 7 and clean_all.isdigit():
...
async def fast_allocate_number_multi(query, context, ranges_list, sid):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📢 OTP GROUP", url="https://t.me/apexverifygroup", style="primary")]
    ])
    try:
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # RANGE SELECT CALLBACK (কান্ট্রি ভিত্তিক নিখুঁত ফিক্সিং সহ)
